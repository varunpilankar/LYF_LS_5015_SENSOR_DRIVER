...
#include "sensor.h"
#include "s5k3m2_F3M2YBN_lib.h"
#include "pdaf_api.h"
#include "pdaf_camif_api.h"

#define SENSOR_MODEL "s5k3m2_F3M2YBN"
...
static struct msm_sensor_exp_gain_info_t exp_gain_info = {
  ...
  .vert_offset = s5k3m2_F3M2YBN_MAX_INTEGRATION_MARGIN,
};
...
static sensor_aec_data_t aec_info = {
  .max_gain = 8.0,
  .max_linecount = 65535 - s5k3m2_F3M2YBN_MAX_INTEGRATION_MARGIN,
};
...
static struct msm_camera_csid_vc_cfg s5k3m2_F3M2YBN_cid_cfg[] = {
  {0, CSI_RAW10, CSI_DECODE_10BIT},
  {1, CSI_EMBED_DATA, CSI_DECODE_8BIT},
};

static struct msm_camera_csi2_params s5k3m2_F3M2YBN_csi_params = {
  .csid_params = {
    .lane_cnt = 4,
    .lut_params = {
      .num_cid = ARRAY_SIZE(s5k3m2_F3M2YBN_cid_cfg),
      .vc_cfg = {
         &s5k3m2_F3M2YBN_cid_cfg[0],
         &s5k3m2_F3M2YBN_cid_cfg[1],
      },
    },
  },
  .csiphy_params = {
...
static struct msm_camera_csi2_params *csi_params[] = {
  &s5k3m2_F3M2YBN_csi_params, /* RES 0*/
  &s5k3m2_F3M2YBN_csi_params, /* RES 1*/
  &s5k3m2_F3M2YBN_csi_params, /* RES 2*/
  &s5k3m2_F3M2YBN_csi_params, /* RES 3*/
  &s5k3m2_F3M2YBN_csi_params, /* RES 4*/
};
...
static struct sensor_pix_fmt_info_t s5k3m2_F3M2YBN_pix_fmt0_fourcc[] = {
  {V4L2_PIX_FMT_SGRBG10},
};

static struct sensor_pix_fmt_info_t s5k3m2_F3M2YBN_pix_fmt1_fourcc[] = {
  {MSM_V4L2_PIX_FMT_META},
};

static sensor_stream_info_t s5k3m2_F3M2YBN_stream_info[] = {
  {1, &s5k3m2_F3M2YBN_cid_cfg[0], s5k3m2_F3M2YBN_pix_fmt0_fourcc},
  {1, &s5k3m2_F3M2YBN_cid_cfg[1], s5k3m2_F3M2YBN_pix_fmt1_fourcc},
};

static sensor_stream_info_array_t s5k3m2_F3M2YBN_stream_info_array = {
  .sensor_stream_info = s5k3m2_F3M2YBN_stream_info,
  .size = ARRAY_SIZE(s5k3m2_F3M2YBN_stream_info),
};
...
static struct sensor_lib_out_info_t sensor_out_info[] = {
  ...
  {/* 60 fps 1080p*/
	...
	.is_pdaf_supported = 0,//added by Jelly for PDAF
  },
  {/* 90 fps 720p */
    .x_output = 1280,
    .y_output = 720,
...
static sensor_res_cfg_type_t s5k3m2_F3M2YBN_res_cfg[] = {
...
static struct sensor_res_cfg_table_t s5k3m2_F3M2YBN_res_table = {
  .res_cfg_type = s5k3m2_F3M2YBN_res_cfg,
  .size = ARRAY_SIZE(s5k3m2_F3M2YBN_res_cfg),
};

static struct sensor_lib_chromatix_t s5k3m2_F3M2YBN_chromatix[] = {
  {
    .common_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(snapshot), /* RES0 */
    .camera_snapshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(snapshot), /* RES0 */
    .camcorder_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(default_video), /* RES0 */
    .liveshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(liveshot), /* RES0 */
  },
  {
    .common_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(preview), /* RES1 */
    .camera_snapshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(preview), /* RES1 */
    .camcorder_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(default_video), /* RES1 */
    .liveshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(liveshot), /* RES1 */
  },
  {
    .common_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(hfr_60), /* RES2 */
    .camera_snapshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(hfr_60), /* RES2 */
    .camcorder_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(hfr_60), /* RES2 */
    .liveshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(liveshot), /* RES2 */
  },
  {
    .common_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(hfr_90), /* RES3 */
    .camera_snapshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(hfr_90), /* RES3 */
    .camcorder_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(hfr_90), /* RES3 */
    .liveshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(liveshot), /* RES3 */
  },
  {
    .common_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(hfr_120), /* RES4 */
    .camera_snapshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(hfr_120), /* RES4 */
    .camcorder_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(hfr_120), /* RES4 */
    .liveshot_chromatix = s5k3m2_F3M2YBN_LOAD_CHROMATIX(liveshot), /* RES4 */
  },
};

static struct sensor_lib_chromatix_array s5k3m2_F3M2YBN_lib_chromatix_array = {
  .sensor_lib_chromatix = s5k3m2_F3M2YBN_chromatix,
  .size = ARRAY_SIZE(s5k3m2_F3M2YBN_chromatix),
};

/*===========================================================================
 * FUNCTION    - s5k3m2_F3M2YBN_real_to_register_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static uint16_t s5k3m2_F3M2YBN_real_to_register_gain(float gain)
{
  uint32_t reg_gain = 0;

  if (gain < S5K3M2_F3M2YBN_MIN_GAIN)
  {
      gain = S5K3M2_F3M2YBN_MIN_GAIN;
  }
  else if (gain > S5K3M2_F3M2YBN_MAX_GAIN)
  {
      gain = S5K3M2_F3M2YBN_MAX_GAIN;
  }
...
/*===========================================================================
 * FUNCTION    - s5k3m2_F3M2YBN_register_to_real_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static float s5k3m2_F3M2YBN_register_to_real_gain(uint16_t reg_gain)
{
  float gain;

  if(reg_gain > S5K3M2_F3M2YBN_MAX_GAIN_REG_VAL)
      reg_gain = S5K3M2_F3M2YBN_MAX_GAIN_REG_VAL;
...
/*===========================================================================
 * FUNCTION    - s5k3m2_F3M2YBN_calculate_exposure -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t s5k3m2_F3M2YBN_calculate_exposure(float real_gain,
  uint16_t line_count, sensor_exposure_info_t *exp_info)
{
  ...
  exp_info->reg_gain              = s5k3m2_F3M2YBN_real_to_register_gain(real_gain);
  exp_info->sensor_real_gain      = s5k3m2_F3M2YBN_register_to_real_gain(exp_info->reg_gain);
...
/*===========================================================================
 * FUNCTION    - s5k3m2_F3M2YBN_fill_exposure_array -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t s5k3m2_F3M2YBN_fill_exposure_array(uint16_t gain,
...
/*===========================================================================
 * FUNCTION    - s5k3m2_F3M2YBN_init_pdaf -
 *
 * DESCRIPTION:
 *==========================================================================*/
unsigned int s5k3m2_F3M2YBN_init_pdaf(void *arg1)
{
...
/*===========================================================================
 * FUNCTION    - s5k3m2_F3M2YBN_pdaf_calculate_defocus -
 *
 * DESCRIPTION: PDAF calcuate defocus
 *==========================================================================*/
int s5k3m2_F3M2YBN_pdaf_calculate_defocus(__attribute__((unused))unsigned int * arg1,
...
/*===========================================================================
 * FUNCTION    - s5k3m2_F3M2YBN_deinit_pdaf -
 *
 * DESCRIPTION: PDAF release resource for API
 *==========================================================================*/
int s5k3m2_F3M2YBN_deinit_pdaf()
{
  int rc = PDAF_LIB_OK;
...
static sensor_exposure_table_t s5k3m2_F3M2YBN_expsoure_tbl = {
  .sensor_calculate_exposure = s5k3m2_F3M2YBN_calculate_exposure,
  .sensor_fill_exposure_array = s5k3m2_F3M2YBN_fill_exposure_array,
};
...
static sensor_lib_t sensor_lib_ptr = {
  ...
  /* sensor eeprom name */
  .eeprom_name = "qtech_s5k3m2_F3M2YBN",
  ...
  /* csi cid params */
  .csi_cid_params = s5k3m2_F3M2YBN_cid_cfg,
  /* csi csid params array size */
  .csi_cid_params_size = ARRAY_SIZE(s5k3m2_F3M2YBN_cid_cfg),
  /* init settings */
  ...
  .sensor_res_cfg_table = &s5k3m2_F3M2YBN_res_table,
  /* res settings */
  ...
  .sensor_stream_info_array = &s5k3m2_F3M2YBN_stream_info_array,
  /* exposure funtion table */
  .exposure_func_table = &s5k3m2_F3M2YBN_expsoure_tbl,
  /* chromatix array */
  .chromatix_array = &s5k3m2_F3M2YBN_lib_chromatix_array,
  /* sensor pipeline immediate delay */
  .sensor_max_immediate_frame_delay = 2,
   .sensorlib_pdaf_api =
  {
      /* PDAF init */
    .init = "s5k3m2_F3M2YBN_init_pdaf",
      /* PDAF calculate defocus */
    .deinit = "s5k3m2_F3M2YBN_deinit_pdaf",
      /* PDAF deinit */
    .calcdefocus = "s5k3m2_F3M2YBN_pdaf_calculate_defocus",
  },
};

/*===========================================================================
 * FUNCTION    - s5k3m2_F3M2YBN_open_lib -
 *
 * DESCRIPTION:
 *==========================================================================*/
void *s5k3m2_F3M2YBN_open_lib(void)
{
