S5K5E2_SFS5C7597_SENSOR_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#                      Make the shared library libmmcamera_s5k5e2_8909
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(S5K5E2_SFS5C7597_SENSOR_LIBS_PATH)
...
LOCAL_SRC_FILES:= s5k5e2_SFS5C7597_lib.c
LOCAL_MODULE           := libmmcamera_s5k5e2_SFS5C7597
