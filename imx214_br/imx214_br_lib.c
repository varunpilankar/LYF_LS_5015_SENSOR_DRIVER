...
#define SENSOR_MODEL_NO_IMX214 "imx214_br"
...
static struct sensor_lib_chromatix_t imx214_chromatix[] = {
#if SNAPSHOT_PARAMS
  {
    ...
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(snapshot), /* RES0 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(snapshot), /* RES0 */
  },
#endif
#if PREVIEW_PARAMS
  {
    ...
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES1 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES1 */
  },
#endif
  {
    .common_chromatix = IMX214_LOAD_CHROMATIX(common),
    ...
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES2 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES2 */
  },
  {
    .common_chromatix = IMX214_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES3 */
    .camera_snapshot_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES3 */
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES3 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES3 */
  },
  {
    .common_chromatix = IMX214_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES4 */
    .camera_snapshot_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES4 */
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES4 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES4 */
  },
  {
    .common_chromatix = IMX214_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES5 */
    .camera_snapshot_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES5 */
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES5 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(preview), /* RES5 */
  },
  {
    .common_chromatix = IMX214_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = IMX214_LOAD_CHROMATIX(snapshot), /* RES6 */
    .camera_snapshot_chromatix = IMX214_LOAD_CHROMATIX(snapshot), /* RES6 */
    .camcorder_chromatix = IMX214_LOAD_CHROMATIX(snapshot), /* RES6 */
    .liveshot_chromatix = IMX214_LOAD_CHROMATIX(snapshot), /* RES6 */
  },
};
...
static sensor_lib_t sensor_lib_ptr = {
  ...
  .actuator_name = "rohm_bu64243gwz_214",
  /* sensor eeprom name */
  .eeprom_name = "sonyimx214",
